...
// Source: https://stackoverflow.com/a/75996347
...
var reUnicodeRange = regexp.MustCompile("[^\u0000-\u007E]")
...
func NormalizeUnicode(str string) string {
	return reUnicodeRange.ReplaceAllStringFunc(str, func(a string) string {
		r, _ := utf8.DecodeRuneInString(a)
		if replacement, ok := diacriticsMap[rune(r)]; ok {
			return replacement
		}

		// Custom replacements not captured in the above logic.
		switch r {
		case 'ð':
			return "o"
		case '’':
